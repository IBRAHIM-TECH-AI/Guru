...
smd({
  ...
  try {
    if (!_0x1c586e) {
      return await _0x1ae8f8.reply("*Provide Repo Url, _.gitclone https://github.com/Kingibrahimtech/Black-panther-md-x_*");
    }
...
smd({
  ...
  try {
    ...
    try {
      ...
      let _0x3448d2 = _0x4e4465.title || _0x3e3caf || _0x421809[0x1] || "Suhail MD -- YT Video";
      if (_0x3e3caf) {
...
smd({
  ...
  try {
    ...
    if (_0x5c93a9.videoDetails.lengthSeconds >= 2000) {
      _0x58ceb6 = "document";
    }
...
smd({
  ...
  try {
    ...
    if (_0x4b5067.videoDetails.lengthSeconds >= 2000) {
      _0x540f68 = "document";
    }
...
smd({
  ...
  try {
    ...
    try {
      ...
      let _0x4b47c3 = "./temp/Suhail-Md " + _0x1d542b[0x1] + '.mp3';
    ...
    let _0x300d1a = {
      ...
      'mimetype': "audio/mpeg",
      'fileName': "Suhail-Md--" + _0x1d542b[0x1] + '.mp3',
      'caption': Config.caption,
...
cmd({
  ...
  if (_0xb75e78.quoted && _0xb75e78.text) {
    ...
    if (_0x5b8ee5[0x0].includes("Black Panther • sᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ")) {
      ...
      if (_0x5b8ee5[0x0].includes("Black Panther • ʏᴏᴜᴛᴜʙᴇ ᴅᴏᴡɴʟᴏᴀᴅ")) {
        ...
        if (_0x5b8ee5[0x0].includes("Black Panther • ᴀᴘᴋ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪsᴛ")) {
...
smd({
  ...
  try {
    ...
    if (!_0x45d2ef || !_0x45d2ef.includes('=') || !/http/gi.test(_0x45d2ef)) {
      return await _0x1283e0.reply("*Use Playlist URL, Like: " + prefix + "playlist https://www.youtube.com/playlist?list=PLZeei0S6_unh-jTeWsJI1mOI6snxeHn5c*");
    }
