...
smd({
  ...
  try {
    let {
      data: _0x44f98c
    } = await axios.get("https://api.github.com/repos/ibrahimaitech/BOTGURU-MD");
    let _0x1c73f9 = ("\n𝑮𝒖𝒓𝒖 𝑴𝑫 𝑰𝒔 𝑻𝒉𝒆 𝑩𝒆𝒔𝒕 𝑩𝒐𝒕 , 𝑪𝒓𝒆𝒂𝒕𝒆𝒅 𝑩𝒚 𝑴𝒓 𝑮𝒖𝒓𝒖  𝑫𝒆𝒑𝒍𝒐𝒚𝒆𝒅 𝒃𝒚 *" + Config.ownername + "*.\n\n  *❲❒❳ Stars:* " + (_0x44f98c?.stargazers_count || "120+") + " stars\n  *❲❒❳ Forks:* " + (_0x44f98c?.forks_count || "1000+") + " forks\n  *❲❒❳ Authors:* IbrahimAdams\n  *❲❒❳ Created On:* " + (_0x44f98c?.created_at || "undefined") + "\n  *❲❒❳ Repo:* _https://github.com/ibrahimaitech/BOTGURU-MD\n  *❲❒❳ Scan:* _" + scan + "_" + (Config.caption ? "\n\n" + Config.caption : "")).trim();
